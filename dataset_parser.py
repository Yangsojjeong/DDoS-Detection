...
def main(argv):
    ...
    if args.preprocess_folder is not None or args.preprocess_file is not None:
        ...
        preprocessed_trainval, preprocessed_test = train_test_split(preprocessed_flows, train_size=0.80, shuffle=True)
        preprocessed_train, preprocessed_val = train_test_split(preprocessed_trainval, train_size=0.75, shuffle=True)
